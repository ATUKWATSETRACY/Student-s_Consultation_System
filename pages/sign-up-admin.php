<?php
  ...
  include '../modules/signup-admin.php';
  ...
  if (isset($_POST['sign-up-admin-btn'])) {

    $mail = $_POST['staff-email'];
    $fname = $_POST['staff-fname'];
    $lname = $_POST['staff-lname'];
    $pass = $_POST['staff-password'];
    $pass2 = $_POST['staff-password2'];
              ...
              <div class="card-body">
                <form role="form" method="POST" class="text-start">
                  <div class="input-group input-group-outline my-3">
                    ...
                    <input type="email" id="staff-email" name="staff-email" class="form-control" required>
                  </div>
                  <div class="input-group input-group-outline mb-3">
                    <label class="form-label">Enter First Name</label>
                    <input type="text" name="staff-fname" class="form-control" required>
                  </div>
                  <div class="input-group input-group-outline mb-3">
                    <label class="form-label">Enter Last Name</label>
                    <input type="text" name="staff-lname" class="form-control" required>
                  </div>
                  <div class="input-group input-group-outline mb-3">
                    <label class="form-label">Enter Password</label>
                    <input type="password" name="staff-password" class="form-control" required>
                  </div>
                  <div class="input-group input-group-outline mb-3">
                    <label class="form-label">Confirm Password</label>
                    <input type="password" name="staff-password2" class="form-control" required>
                  </div>
                  <div class="text-center">
                    <button type="submit" name="sign-up-admin-btn" class="btn bg-gradient-primary w-100 my-4 mb-2">Sign up</button>
                  </div>
                </form>
